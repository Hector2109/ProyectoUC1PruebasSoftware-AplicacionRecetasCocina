...
public class DlgIngredientesReceta extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        setPreferredSize(new java.awt.Dimension(1499, 855));
        ...
        fondo.setPreferredSize(new java.awt.Dimension(1499, 855));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DlgIngredientesReceta.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DlgIngredientesReceta dialog = new DlgIngredientesReceta(new javax.swing.JFrame(), true);
